...
try {
    ...
    $sql = "SELECT o.id_oferta, o.id_categoria, o.cargo, o.descripcion,
                   o.experiencia_requerida, o.habilidades_requeridas,
                   o.datos_contacto, o.estado, o.fecha_publicacion,
